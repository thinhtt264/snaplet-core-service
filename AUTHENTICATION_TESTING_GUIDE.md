...
3. [Các Endpoint Authentication](#các-endpoint-authentication)
   - 3.1. [Check Email Available](#1-check-email-available)
   - 3.2. [Check Username Available](#2-check-username-available)
   - 3.3. [Register (Đăng Ký)](#3-register-đăng-ký)
   - 3.4. [Login (Đăng Nhập)](#4-login-đăng-nhập)
   - 3.5. [Refresh Token](#5-refresh-token)
   - 3.6. [Verify Token](#6-verify-token)
   - 3.7. [Logout](#7-logout)
